      ...
      <section class="login-content">
         <div class="row m-0 align-items-center bg-white vh-100">            
                              ...
                              <div class="d-flex justify-content-center">
                                  <ul class="list-group list-group-horizontal list-group-flush">
                                      <li class="list-group-item border-0 pb-0">
                                          <a href="#"><img src="{{ asset('assets/auth/images/brands/fb.svg') }}" alt="Facebook"></a>
                                      </li>
                                      <li class="list-group-item border-0 pb-0">
                                          <a href="#"><img src="{{ asset('assets/auth/images/brands/gm.svg') }}" alt="Google"></a>
                                      </li>
                                      <li class="list-group-item border-0 pb-0">
                                          <a href="#"><img src="{{ asset('assets/auth/images/brands/im.svg') }}" alt="Instagram"></a>
                                      </li>
                                      <li class="list-group-item border-0 pb-0">
                                          <a href="#"><img src="{{ asset('assets/auth/images/brands/li.svg') }}" alt="LinkedIn"></a>
                                      </li>
                                  </ul>
                              </div>
            ...
            <div class="col-md-6 d-md-block d-none bg-primary p-0 mt-n1 vh-100 overflow-hidden">
               <img src="{{ asset('assets/auth/images/auth/01.png') }}" class="img-fluid gradient-main animated-scaleX" alt="images">
            </div>
         </div>
      </section>
      </div>
